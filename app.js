...
document.getElementById('runManifestBtn').addEventListener('click', async ()=>{
  ...
  try{
    ...
    const { plan, summary, portfolio } = buildManifestPlan(records, state.demand, state.feeRateTable||{}, state.defaultFeePerUnit, method, minCov, null);
